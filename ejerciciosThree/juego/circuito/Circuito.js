...
class Circuito extends THREE.Object3D {
  ...
  createBase(tama) {
    ...
    const rainbowTexture = textureLoader.load('r.png'); // Cambia 'ruta/a/tu/imagen/arcoiris.avif' por la ruta real

    // Crear el material del tubo con la textura cargada
    const tubeMaterial = new THREE.MeshStandardMaterial({ map: rainbowTexture, side: THREE.DoubleSide });
